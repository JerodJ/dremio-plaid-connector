...
@SourceType(value = "PlaidARP", label = "Plaid",uiConfig = "plaid-layout.json")
public class PlaidConf extends AbstractArpConf<PlaidConf> {
  private static final String ARP_FILENAME = "arp/implementation/plaid-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.plaid.PlaidDriver";
